...
import logo from '../Assets/CBJ.jpeg';
        ...
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">
              <img src={logo} alt="CBJ Logo" className="navbar-logo" style={{ width: '150px', height: '1  50px', objectFit: 'cover' }} />
            </p>
            <p className="ft-description">
              Talk with us and get your wishlist product, online
              satisfaction, and good products within minutes. On-demand
