    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to CBJ Accessories, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using CBJ Accessories, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          CBJ Accessories is designed to simplify healthcare access. You can choose
